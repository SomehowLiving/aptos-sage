            ...
            {navigationItems.map((item) => {
              ...
              return (
                <Button
                  ...
                  className={cn(
                    "w-full justify-start h-auto p-3 text-left group transition-all",
                    isActive 
...
//         <div className="flex items-center space-x-3">
//           <div className="w-10 h-6 bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl flex items-center justify-center">
